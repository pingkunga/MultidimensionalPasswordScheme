			...
			//writelog(logD_action,logD_interaction,logD_input,logD_status,logD_remark)
				...
				success: function(data){
					...
					if(data==1){
						...
						//writelog(logD_action,logD_interaction,logD_input,logD_status,logD_remark)
					    writelog("-","-","-","error",">> Password is empty!!!");
					}else if(data==0){
								...
								<div id="wizard" class="swMain">
									...
									<?php if($type=="registration"){
										echo '<ul class="anchor">
											...
											<li><a href="#step-3" class="selected"> <label
													class="stepNumber">3</label> <span class="stepDesc"> Step 3<br />
														<small>Step 3 Create password</small>
												</span>
											</a>
											</li>
											<li><a href="#step-4" class="disabled"> <label
